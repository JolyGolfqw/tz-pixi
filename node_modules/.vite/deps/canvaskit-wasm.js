...
var require_canvaskit = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var CanvasKitInit = (() => {
		...
		return (async function(moduleArg = {}) {
				...
				a.Pd.push(function() {
					...
					a.TextBlob.MakeOnPath = function(e, c, g, l) {
						if (e && e.length && c && c.countPoints()) {
							...
							for (var A = c.next(), H = new Float32Array(4), L = 0; L < e.length && A; L++) {
								var M = t[L];
								l += M / 2;
								if (l > A.length()) {
									A.delete();
			...
			for (var Pd = new Float32Array(288), Qd = 0; 288 >= Qd; ++Qd) Hd[Qd] = Pd.subarray(0, Qd);
			var Rd = new Int32Array(288);
...
//#endregion
export default require_canvaskit();

//# sourceMappingURL=canvaskit-wasm.js.map